...
void main() => runApp(MyApp(initOption: 1));
Ads ads;
...
class _MyAppState extends State<MyApp> {
  ...
  final String appId = Platform.isAndroid
      ? 'ca-app-pub-6940145434278713~6232539460'
      : 'ca-app-pub-3940256099942544~1458002511';

  final String bannerUnitId = Platform.isAndroid
      ? 'ca-app-pub-6940145434278713/9600938837'
      : 'ca-app-pub-3940256099942544/2934735716';

  final String screenUnitId = Platform.isAndroid
      ? 'ca-app-pub-6940145434278713/4344742729'
      : 'ca-app-pub-3940256099942544/4411468910';

  final String videoUnitId = Platform.isAndroid
      ? 'ca-app-pub-6940145434278713/3091370803'
  ...
  void initState() {
    ...
    switch (initOption) {
      ...
      case 2:
        ...
        var videoListener = (event, {String rewardType, int rewardAmount}) {
    ...
    ads.eventListener = (event) {
      ...
      } else if (event == MobileAdEvent.impression) {
...
//      }
    ...
    MobileAdListener eventHandler = (event) {
...
//      }
    ...
    ads.videoListener = (event, {String rewardType, int rewardAmount}) {
